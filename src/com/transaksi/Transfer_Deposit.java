...
import com.transaksi.Transfer_Deposit;
import com.transaksi.R;
import com.transaksi.FormatRP;

public class Transfer_Deposit extends Activity {
	EditText kode_agen;
	EditText nominal;
	EditText no_pin;
    public void onCreate(Bundle savedInstanceState) {
        ...
        super.onStart();
        setContentView(R.layout.transfer_deposit);
        ...
        // Listening to News Feed button click
           btn_ok.setOnClickListener(new View.OnClickListener() {
   			...
   			public void onClick(View view) {
   	   		...
   	   		if (agen_kode.length()>0 && agen_kode.length()<100 && nom.length()>0)  {	
